...
<div class="feedback">
	<div class="feed">
	  ...
	  <form:form method="post" modelAttribute="booking">
	     ...
	     <form>
		    ...
		    <form:input type="text" value="" path="bookingId"/>
    ...
    <tbody>
      ...
      <tr>
        <td>BookingId</td>
        <td>${sessionScope.book_detail.bookingId}</td>
      </tr>
      <tr>
        <td>BookingDate </td>
        <td>${sessionScope.book_detail.bookingDate}</td>
      </tr>
      <tr>
        <td>Status </td>
        <td>${sessionScope.book_detail.status}</td>
      </tr>
    </tbody>
  </table>
	  </form:form>
