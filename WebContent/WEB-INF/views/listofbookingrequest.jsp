...
<div class="feedback">
    ...
    <tbody>
    <c:forEach var="ac" items="${sessionScope.list_book}">
      <tr>
       <td><form:radiobutton path="mobileno" value="${ac.customer.mobileno}"/></td>
        <td>${ac.bookingId}</td>
        <td>${ac.bookingDate}</td>
        <td>${ac.status}</td>
        <td>${ac.customer.firstname}</td>
         <td>${ac.customer.address}</td>
        <td>${ac.customer.mobileno}</td>
        <td>${ac.customer.email}</td>
        <td>${ac.customer.connectiontype}</td>
